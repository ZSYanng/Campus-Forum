...
public class UserService {
    ...
    public boolean setMoney(Integer money,Integer stuId,Integer type){
        if(type == 1){
            return userDao.setMoney1(money, stuId) == 1; // type为1，加钱，否则扣钱
        }else{
    ...
    public User getAll(Integer stuId){
        return userDao.getUser2(stuId);
    }

    public boolean updateName(Integer stuId,String newName){
        return userDao.updateName(stuId,newName) == 1;
    }
    public boolean updatePhoto(Integer stuId,String photo){
        return userDao.updatePhoto(stuId,photo) == 1;
    }
